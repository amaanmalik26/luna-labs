  ...
  <div class="max-w-7xl mx-auto">
    ...
    <ScrollReveal>
      <div class="mb-16 space-y-4 max-w-2xl">
        ...
        <h2 id="services-heading" class="text-5xl lg:text-6xl font-black tracking-tight">
          Precision-built
    ...
    <!-- Cards stagger in with increasing delay -->
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      {#each services as service, i}
        <ScrollReveal delay={i * 150} distance={40}>
          <article
            class="service-card luna-glass rounded-2xl p-8 flex flex-col gap-6 h-full"
          ...
          >
            ...
            <div class="space-y-3 flex-1">
              ...
              <p class="text-luna-gold text-xs font-bold uppercase tracking-widest">{service.tagline}</p>
              <p class="text-luna-text-muted text-sm leading-relaxed">{service.description}</p>
            </div>
