...
create table if not exists public.projects (
  ...
  gradient     text        not null default 'linear-gradient(135deg, #0066FF 0%, #8A2BE2 100%)',
...
values
  (
    ...
    'in-progress',
    'linear-gradient(135deg, #0066FF 0%, #8A2BE2 50%, #00F0FF 100%)',
    '2025',
    true,
    true,
    0
  ...
  (
    ...
    'concept',
    'linear-gradient(135deg, #1E143C 0%, #0066FF 60%, #00F0FF 100%)',
    '2025',
    false,
    true,
    10
  ...
  (
    ...
    'concept',
    'linear-gradient(135deg, #D4AF37 0%, #8A2BE2 70%, #0B0914 100%)',
    '2025',
    false,
    true,
    20
  ...
  (
    ...
    'concept',
    'linear-gradient(135deg, #00F0FF 0%, #0066FF 50%, #1E143C 100%)',
    '2025',
    false,
    true,
    30
